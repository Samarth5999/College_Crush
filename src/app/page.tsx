        ...
        <div className="w-full max-w-7xl mx-auto px-4 py-20 flex flex-col justify-center items-center min-h-screen">
          <div className="text-center space-y-8 w-full max-w-4xl">
            <h1 className="text-6xl md:text-6xl font-bold text-center ">
              <span className="inline-block whitespace-nowrap bg-gradient-to-r from-pink-500 to-red-500 text-transparent bg-clip-text transform hover:scale-105 transition-transform cursor-default">
                Attendance Low, Standards Lower
              </span>
            </h1>
